...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            @csrf
            <form id="Form_Form" method="POST" autocomplete="off" enctype="multipart/form-data">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $("#Form_Form").submit(function (e) {
            ...
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.rdeProg.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'New Research Development & Extension Program successfully added!',
                        icon: 'success',
