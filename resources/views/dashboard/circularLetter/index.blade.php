...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="circular_letter_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="circular_letter_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            circular_letter_tbl = $("#circular_letter_table").DataTable({
              'dom' : 'lBfrtip',
              "processing": true,
              "serverSide": true,
              "ajax" : '{{ route("dashboard.circularLetter.index") }}',
              "columns": [
                { "data": "crop_year" },
                  { "data": "date" },
                  { "data": "file_title" },
              ...
              "initComplete": function( settings, json ) {
                $('#tbl_loader').fadeOut(function(){
                  $("#circular_letter_table_container").fadeIn();
                });
              },
              "language":
                      {
              ...
              "drawCallback": function(settings){
                ...
                if(active != ''){
                  $("#circular_letter_table #"+active).addClass('success');
                }
              }
            })
            
            style_datatable("#circular_letter_table");
            
            //Need to press enter to search
            $('#circular_letter_table_filter input').unbind();
            $('#circular_letter_table_filter input').bind('keyup', function (e) {
              if (e.keyCode == 13) {
                  circular_letter_tbl.search(this.value).draw();
              }
            });
        });
