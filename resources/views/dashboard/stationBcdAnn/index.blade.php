...
@section('content')
    ...
    <section class="content-header">
        <h1>Manage Extension Services To Bacolod Station</h1>
    </section>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add Announcement To Bacolod Station </h4>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            station_bcd_extserv_tbl = $("#block_farm_table").DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.stationBcdAnn.index") }}',
                "columns": [
                    { "data": "year" },
                    { "data": "date"},
                    { "data": "file_title" },
        ...
        $("#roadMapForm").submit(function (e) {
            ...
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.stationBcdAnn.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'Your New Announcement successfully added to Bacolod Station !',
                        icon: 'success',
