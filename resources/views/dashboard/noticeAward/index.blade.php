...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="NoticeAward_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="NoticeAward_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            notice_award_tbl = $("#NoticeAward_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.noticeAward.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "date"},
                    { "data": "file_title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#NoticeAward_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#NoticeAward_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#NoticeAward_table");

            //Need to press enter to search
            $('#NoticeAward_table_filter input').unbind();
            $('#NoticeAward_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    notice_award_tbl.search(this.value).draw();
                }
            });
        });
