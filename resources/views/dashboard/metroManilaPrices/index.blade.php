...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="metro_manila_prices_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="metro_manila_prices_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            metro_manila_prices_tbl = $("#metro_manila_prices_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.metroManilaPrices.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "file_title" },
                    { "data": "title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#metro_manila_prices_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#metro_manila_pricess_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#metro_manila_prices_table");

            //Need to press enter to search
            $('#metro_manila_prices_table_filter input').unbind();
            $('#metro_manila_prices_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    metro_manila_prices_tbl.search(this.value).draw();
                }
            });
        });
