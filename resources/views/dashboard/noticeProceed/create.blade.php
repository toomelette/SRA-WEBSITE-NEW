...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            @csrf
            <form id="NoticeProceedForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-footer">
                    <button id="btnNoticeProceedSubmit" type="submit" class="btn btn-default">Save</button>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#NoticeProceedForm").submit(function (e) {
            e.preventDefault();
            let form = $(this);
            let formData = new FormData(this);
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.noticeProceed.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    $('form').trigger("reset");
                    $('#btnNoticeProceedSubmit').removeAttr("disabled");
                    Swal.fire({
                        title: 'Success!',
                        text: 'Notice of Proceed successfully added!',
                        icon: 'success',
