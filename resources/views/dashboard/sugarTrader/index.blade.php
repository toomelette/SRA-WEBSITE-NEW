...
@section('content')
    ...
    <section class="content-header">
        <h1>Manage Sugar Trader</h1>
    </section>

    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Sugar Trader</h3>
            ...
            <div class="box-body">
                <div id="sugar_trader_table_container" style="display: none">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            sugar_trader_tbl = $("#sugar_trader_table").DataTable({
              'dom' : 'lBfrtip',
              "processing": true,
              "serverSide": true,
              ...
              "initComplete": function( settings, json ) {
                $('#tbl_loader').fadeOut(function(){
                  $("#sugar_trader_table_container").fadeIn();
                });
              },
              "language":
                      {
              ...
              "drawCallback": function(settings){
                ...
                if(active != ''){
                  $("#sugar_trader_table #"+active).addClass('success');
                }
              }
            })
            
            style_datatable("#sugar_trader_table");
            
            //Need to press enter to search
            $('#sugar_trader_table_filter input').unbind();
            $('#sugar_trader_table_filter input').bind('keyup', function (e) {
              if (e.keyCode == 13) {
                  sugar_trader_tbl.search(this.value).draw();
              }
            });
        });
