...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="MillingSchedule_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="MillingSchedule_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            milling_schedule_tbl = $("#MillingSchedule_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.millingSchedule.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "date"},
                    { "data": "file_title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#MillingSchedule_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#MillingSchedule_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#MillingSchedule_table");

            //Need to press enter to search
            $('#MillingSchedule_table_filter input').unbind();
            $('#MillingSchedule_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    milling_schedule_tbl.search(this.value).draw();
                }
            });
        });
