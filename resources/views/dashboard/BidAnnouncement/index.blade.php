...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="BidAnnouncement_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="BidAnnouncement_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            bid_announcement_tbl = $("#BidAnnouncement_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.bidAnnouncement.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "date"},
                    { "data": "file_title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#BidAnnouncement_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#BidAnnouncement_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#BidAnnouncement_table");

            //Need to press enter to search
            $('#BidAnnouncement_table_filter input').unbind();
            $('#BidAnnouncement_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    bid_announcement_tbl.search(this.value).draw();
                }
            });
        });
