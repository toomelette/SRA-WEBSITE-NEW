...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            @csrf
            <form id="BidAnnouncementForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-footer">
                    <button id="btnBidAnnouncementSubmit" type="submit" class="btn btn-default">Save</button>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#BidAnnouncementForm").submit(function (e) {
            e.preventDefault();
            let form = $(this);
            let formData = new FormData(this);
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.bidAnnouncement.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    $('form').trigger("reset");
                    $('#btnBidAnnouncementSubmit').removeAttr("disabled");
                    Swal.fire({
                        title: 'Success!',
                        text: 'New Bid Announcement successfully added!',
                        icon: 'success',
