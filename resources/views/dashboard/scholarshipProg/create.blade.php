...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            @csrf
            <form id="ScholarshipProg_Form" method="POST" autocomplete="off" enctype="multipart/form-data">

                <div class="box-body">

                    <div class="col-md-11">
                        {!! __form::select_static2(
                          '8 year', 'year', 'Year: *', '', \App\Swep\Helpers\Helper::option_scholarship(), '', '', '', 'required'
                        ) !!}
                ...
                <div class="box-footer">
                    <button id="btnFormSubmit" type="submit" class="btn btn-default">Save</button>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $("#ScholarshipProg_Form").submit(function (e) {
            e.preventDefault();
            let form = $(this);
            let formData = new FormData(this);
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.scholarshipProg.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'New Scholarship Program successfully added!',
                        icon: 'success',
