...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="Sida_Laws_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="Sida_Laws_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            sida_laws_tbl = $("#Sida_Laws_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.sidaLaws.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "date"},
                    { "data": "file_title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#Sida_Laws_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#Sida_Laws_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#Sida_Laws_table");

            //Need to press enter to search
            $('#Sida_Laws_table_filter input').unbind();
            $('#Sida_Laws_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    sida_laws_tbl.search(this.value).draw();
                }
            });
        });
