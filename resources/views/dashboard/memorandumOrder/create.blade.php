...
<section class="content">
    ...
    <div class="box">
      ...
      @csrf
      <form id="memorandumOrderForm" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="box-footer">
          <button id="btnMemorandumOrderSubmit" type="submit" class="btn btn-default">Save</button>
        </div>
...
@section('scripts')
  ...
  <script type="text/javascript">
    ...
    $("#memorandumOrderForm").submit(function (e) {
      e.preventDefault();
      let form = $(this);
      let formData = new FormData(this);
      loading_btn(form);
      $.ajax({
        url: "{{route('dashboard.memorandumOrder.store')}}",
        type: 'POST',
