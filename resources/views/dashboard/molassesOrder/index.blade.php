...
@section('scripts')
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      active = '';
      molasses_order_tbl = $("#molasses_order_table").DataTable({
        'dom' : 'lBfrtip',
        "processing": true,
        "serverSide": true,
        "ajax" : '{{ route("dashboard.molassesOrder.index") }}',
        "columns": [
          { "data": "crop_year" },
          { "data": "file_title" },
          { "data": "title" },
      ...
      $('#molasses_order_table_filter input').bind('keyup', function (e) {
        if (e.keyCode == 13) {
          molasses_order_tbl.search(this.value).draw();
        }
      });
    });
