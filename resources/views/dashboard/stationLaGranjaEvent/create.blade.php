...
@section('content')
    ...
    <section class="content-header">
        <h1>Add Event To La Granja Station </h1>
    </section>
            ...
            <form id="roadMapForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11">
                        ...
                        {!! __form::textbox(
                          '8', 'file_title', 'text', 'Event File Title *', '', old('file_title'), $errors->has('file_title'), $errors->first('file_title'), 'required'
                        ) !!}

                        {!! __form::textbox(
                          '8', 'title', 'text', 'Event Title *', '', old('title'), $errors->has('title'), $errors->first('title'), 'required'
                        ) !!}
