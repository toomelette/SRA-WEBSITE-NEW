            ...
            <form id="roadMapForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11">
                        ...
                        {!! __form::textbox(
                          '8', 'title', 'text', 'Roadmap Title *', 'Roadmap Title', old('title'), $errors->has('title'), $errors->first('title'), 'required'
                        ) !!}
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $("#roadMapForm").submit(function (e) {
            ...
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.roadMap.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'Roadmap successfully added!',
                        icon: 'success',
