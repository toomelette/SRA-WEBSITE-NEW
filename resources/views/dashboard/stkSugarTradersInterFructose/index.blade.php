...
@section('content')
    ...
    <section class="content-header">
        <h1>Manage Sugar Trader International for Fructose</h1>
    </section>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            stk_sugar_traders_inter_fructose_tbl = $("#block_farm_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.stkSugarTradersInterFructose.index") }}',
                "columns": [
                    { "data": "year" },
                    { "data": "date"},
                    { "data": "file_title" },
            ...
            $('#block_farm_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    stk_sugar_traders_inter_fructose_tbl.search(this.value).draw();
                }
            });
        });
        ...
        $("#roadMapForm").submit(function (e) {
            ...
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.stkSugarTradersInterFructose.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'Your New Sugar Trader successfully added to Sugar Traders International for Fructose!',
                        icon: 'success',
