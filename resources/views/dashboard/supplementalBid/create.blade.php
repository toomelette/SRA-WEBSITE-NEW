...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            @csrf
            <form id="supplementalBidForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11">
                        ...
                        '8 crop_year', 'crop_year', 'Crop Year: *', '', \App\Swep\Helpers\Helper::year(), '', '', '', 'required'
                        ) !!}
                        {!! __form::textbox(
                ...
                <div class="box-footer">
                    <button id="btnSupplementalBidSubmit" type="submit" class="btn btn-default">Save</button>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#supplementalBidForm").submit(function (e) {
            e.preventDefault();
            let form = $(this);
            let formData = new FormData(this);
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.supplementalBid.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    $('form').trigger("reset");
                    $('#btnSupplementalBidSubmit').removeAttr("disabled");
                    Swal.fire({
                        title: 'Success!',
                        text: 'New Supplemental Bid successfully added!',
                        icon: 'success',
