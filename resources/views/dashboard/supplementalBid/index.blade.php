...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="supplemental_bid__table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="supplemental_bid__table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            supplemental_bid__tbl = $("#supplemental_bid__table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.supplementalBid.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "date"},
                    { "data": "file_title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#supplemental_bid__table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#supplemental_bid__table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#supplemental_bid__table");

            //Need to press enter to search
            $('#supplemental_bid__table_filter input').unbind();
            $('#supplemental_bid__table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    supplemental_bid__tbl.search(this.value).draw();
                }
            });
        });
