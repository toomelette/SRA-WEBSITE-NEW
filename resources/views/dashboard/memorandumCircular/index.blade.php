...
@section('content')
    ...
    <section class="content-header">
        <h1>Manage Memorandum Circular</h1>
    </section>
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="memorandum_circular_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="memorandum_circular_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            memorandum_circular_tbl = $("#memorandum_circular_table").DataTable({
              'dom' : 'lBfrtip',
              "processing": true,
              "serverSide": true,
              "ajax" : '{{ route("dashboard.memorandumCircular.index") }}',
              "columns": [
                { "data": "year" },
                  { "data": "date" },
                  { "data": "file_title" },
              ...
              "initComplete": function( settings, json ) {
                $('#tbl_loader').fadeOut(function(){
                  $("#memorandum_circular_table_container").fadeIn();
                });
              },
              "language":
                      {
              ...
              "drawCallback": function(settings){
                ...
                if(active != ''){
                  $("#memorandum_circular_table #"+active).addClass('success');
                }
              }
            })
            
            style_datatable("#memorandum_circular_table");
            
            //Need to press enter to search
            $('#memorandum_circular_table_filter input').unbind();
            $('#memorandum_circular_table_filter input').bind('keyup', function (e) {
              if (e.keyCode == 13) {
                  memorandum_circular_tbl.search(this.value).draw();
              }
            });
        });
