...
<section class="content">
    ...
    <div class="box">
      ...
      @csrf
      <form id="memorandumCircularForm" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="box-footer">
          <button id="btnMemorandumCircularSubmit" type="submit" class="btn btn-default">Save</button>
        </div>
...
@section('scripts')
  ...
  <script type="text/javascript">
    ...
    $("#memorandumCircularForm").submit(function (e) {
      e.preventDefault();
      let form = $(this);
      let formData = new FormData(this);
      loading_btn(form);
      $.ajax({
        url: "{{route('dashboard.memorandumCircular.store')}}",
        type: 'POST',
        ...
        success: function (res) {
          $('form').trigger("reset");
          $('#btnMemorandumCircularSubmit').removeAttr('disabled');
          Swal.fire({
            title: 'Success!',
            text: 'Memorandum Circular successfully added!',
            icon: 'success',
