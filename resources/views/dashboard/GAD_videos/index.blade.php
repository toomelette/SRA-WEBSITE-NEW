        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add GAD Videos</h4>
                </div>
                        ...
                        <form id="roadMapForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    {!! __form::file(
                                     '8', 'video[]', 'Upload Video *', $errors->has('img_url'), $errors->first('img_url'), 'required'
                                    ) !!}
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            gad_annual_report_tbl = $("#block_farm_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.GAD_videos.index") }}',
                "columns": [
                    { "data": "year" },
                    { "data": "date"},
                    { "data": "file_title" },
            ...
            $('#block_farm_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    gad_annual_report_tbl.search(this.value).draw();
                }
            });
        });
        ...
        $("#roadMapForm").submit(function (e) {
            ...
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.GAD_videos.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'Your New Video successfully added to GAD Videos!',
                        icon: 'success',
