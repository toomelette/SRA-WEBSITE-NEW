...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="FundUtilization_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="FundUtilization_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            fund_utilization_tbl = $("#FundUtilization_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.fundUtilization.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "date"},
                    { "data": "file_title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#FundUtilization_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#FundUtilization_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#FundUtilization_table");

            //Need to press enter to search
            $('#FundUtilization_table_filter input').unbind();
            $('#FundUtilization_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    fund_utilization_tbl.search(this.value).draw();
                }
            });
        });
