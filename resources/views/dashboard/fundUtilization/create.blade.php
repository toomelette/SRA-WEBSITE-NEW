...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            @csrf
            <form id="FundUtilizationForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11">
                        ...
                        {!! __form::textbox(
                          '8', 'description', 'text', 'Description *', '', old('description'), $errors->has('description'), $errors->first('description'), 'required'
                        ) !!}
                ...
                <div class="box-footer">
                    <button id="btnFundUtilizationSubmit" type="submit" class="btn btn-default">Save</button>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#FundUtilizationForm").submit(function (e) {
            e.preventDefault();
            let form = $(this);
            let formData = new FormData(this);
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.fundUtilization.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    $('form').trigger("reset");
                    $('#btnFundUtilizationSubmit').removeAttr("disabled");
                    Swal.fire({
                        title: 'Success!',
                        text: 'New fund Utilization successfully added!',
                        icon: 'success',
