...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            @csrf
            <form id="PhilgepsPostingForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-footer">
                    <button id="btnPhilgepsPostingSubmit" type="submit" class="btn btn-default">Save</button>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#PhilgepsPostingForm").submit(function (e) {
            e.preventDefault();
            let form = $(this);
            let formData = new FormData(this);
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.philgepsPosting.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    $('form').trigger("reset");
                    $('#btnPhilgepsPostingSubmit').removeAttr("disabled");
                    Swal.fire({
                        title: 'Success!',
                        text: 'Philgeps Posting successfully added!',
                        icon: 'success',
