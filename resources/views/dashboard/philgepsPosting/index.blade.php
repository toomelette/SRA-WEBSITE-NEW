...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="PhilgepsPosting_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="PhilgepsPosting_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            philgeps_posting_tbl = $("#PhilgepsPosting_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.philgepsPosting.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "date"},
                    { "data": "file_title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#PhilgepsPosting_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#PhilgepsPosting_tbl_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#PhilgepsPosting_table");

            //Need to press enter to search
            $('#PhilgepsPosting_table_filter input').unbind();
            $('#PhilgepsPosting_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    philgeps_posting_tbl.search(this.value).draw();
                }
            });
        });
