...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            @csrf
            <form id="SidaGuideLinesForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-footer">
                    <button id="btnSidaGuideLinesSubmit" type="submit" class="btn btn-default">Save</button>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#SidaGuideLinesForm").submit(function (e) {
            e.preventDefault();
            let form = $(this);
            let formData = new FormData(this);
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.sidaGuideLines.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    $('form').trigger("reset");
                    $('#btnSidaGuideLinesSubmit').removeAttr("disabled");
                    Swal.fire({
                        title: 'Success!',
                        text: 'New SIDA Guideline successfully added!',
                        icon: 'success',
