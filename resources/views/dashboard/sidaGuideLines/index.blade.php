...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="SidaGuideLines_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="SidaGuideLines_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            sida_guide_lines_tbl = $("#SidaGuideLines_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.sidaGuideLines.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "date"},
                    { "data": "file_title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#SidaGuideLines_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#SidaGuideLines_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#SidaGuideLines_table");

            //Need to press enter to search
            $('#SidaGuideLines_table_filter input').unbind();
            $('#SidaGuideLines_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    sida_guide_lines_tbl.search(this.value).draw();
                }
            });
        });
