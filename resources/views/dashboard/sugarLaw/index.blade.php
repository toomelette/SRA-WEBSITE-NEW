...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="sugar_law_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="sugar_law_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            sugar_law_tbl = $("#sugar_law_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#sugar_law_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#sugar_law_table #"+active).addClass('success');
                    }
                }
            })
            ...
            $('#sugar_law_table_filter input').unbind();
            $('#sugar_law_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
