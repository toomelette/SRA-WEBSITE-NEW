...
@section('content')
    ...
    <section class="content-header">
        <h1>SIDA INFRASTRUCTURE (FMR PROJECT)</h1>
    </section>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            sida_infas_fmr_tbl = $("#block_farm_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.SidaInfrasFMR.index") }}',
                "columns": [
                    { "data": "year" },
                    { "data": "date"},
                    { "data": "file_title" },
            ...
            $('#block_farm_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    sida_infas_fmr_tbl.search(this.value).draw();
                }
            });
        });
