...
<section class="content">
    ...
    <div class="box">
      ...
      @csrf
      <form id="sugarOrderForm" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="box-footer">
          <button id="btnsugarOrder" type="submit" class="btn btn-default">Save</button>
        </div>
...
@section('scripts')
  ...
  <script type="text/javascript">
    ...
    $("#sugarOrderForm").submit(function (e) {
      e.preventDefault();
      let form = $(this);
      let formData = new FormData(this);
      loading_btn(form);
      $.ajax({
        url: "{{route('dashboard.sugarOrder.store')}}",
        type: 'POST',
        ...
        success: function (res) {
          $('form').trigger("reset");
          $('#btnsugarOrder').removeAttr("disabled");
          Swal.fire({
            title: 'Success!',
            text: 'Sugar Order successfully added!',
            icon: 'success',
