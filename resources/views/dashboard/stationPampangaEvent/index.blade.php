...
@section('content')
    ...
    <section class="content-header">
        <h1>Manage Event Pampanga Station</h1>
    </section>
                ...
                <div id="block_farm_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="block_farm_table" style="width: 100% !important">
                        ...
                        <tr class="">
                            ...
                            <th width="20%" class="">Event File Title</th>
                            <th width="35%" class="">Event Title</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add Event To Pampanga Station</h4>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            station_pampanga_event_tbl = $("#block_farm_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.stationPampangaEvent.index") }}',
                "columns": [
                    { "data": "year" },
                    { "data": "date"},
                    { "data": "file_title" },
            ...
            $('#block_farm_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    station_pampanga_event_tbl.search(this.value).draw();
                }
            });
        });
        ...
        $("#roadMapForm").submit(function (e) {
            ...
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.stationPampangaEvent.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'Your New Event successfully added to Pampanga Station!',
                        icon: 'success',
