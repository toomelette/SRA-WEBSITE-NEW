...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            @csrf
            <form id="InvitationBidForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11">
                        ...
                        {!! __form::textbox(
                          '8', 'title', 'text', 'Title *', 'Invitation Title', old('title'), $errors->has('title'), $errors->first('title'), 'required'
                        ) !!}
                ...
                <div class="box-footer">
                    <button id="btnInvitationBidSubmit" type="submit" class="btn btn-default">Save</button>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#InvitationBidForm").submit(function (e) {
            e.preventDefault();
            let form = $(this);
            let formData = new FormData(this);
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.invitationBid.store')}}",
                type: 'POST',
