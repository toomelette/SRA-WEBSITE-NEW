        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add Memorandum</h4>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            gad_annual_report_tbl = $("#block_farm_table").DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.GAD_memorandum.index") }}',
                "columns": [
                    { "data": "year" },
                    { "data": "date"},
                    { "data": "file_title" },
        ...
        $("#roadMapForm").submit(function (e) {
            ...
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.GAD_memorandum.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'Your New Memorandum successfully added to GAD Memorandum!',
                        icon: 'success',
