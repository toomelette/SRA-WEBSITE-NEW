...
<section class="content-header">
    <h1>Add General Administrative Order</h1>
</section>
...
<section class="content">
    ...
    <div class="box">
      ...
      @csrf
      <form id="generalAdministrativeOrderForm" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="box-footer">
          <button id="btnGeneralAdministrativeOrderSubmit" type="submit" class="btn btn-default">Save</button>
        </div>
...
@section('scripts')
  ...
  <script type="text/javascript">
    ...
    $("#generalAdministrativeOrderForm").submit(function (e) {
      e.preventDefault();
      let form = $(this);
      let formData = new FormData(this);
      loading_btn(form);
      $.ajax({
        url: "{{route('dashboard.generalAdministrativeOrder.store')}}",
        type: 'POST',
        ...
        success: function (res) {
          $('form').trigger("reset");
          $('#btnGeneralAdministrativeOrderSubmit').removeAttr('disabled');
          Swal.fire({
            title: 'Success!',
            text: 'General Administrative Order successfully added!',
            icon: 'success',
