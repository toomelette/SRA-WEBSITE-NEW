...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="sugar_statistics_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="sugar_statistics_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            sugar_statistics_tbl = $("#sugar_statistics_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.sugarStatistics.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "file_title" },
                    { "data": "title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#sugar_statistics_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#sugar_statistics_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#sugar_statistics_table");

            //Need to press enter to search
            $('#sugar_statistics_table_filter input').unbind();
            $('#sugar_statistics_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    sugar_statistics_tbl.search(this.value).draw();
                }
            });
        });
