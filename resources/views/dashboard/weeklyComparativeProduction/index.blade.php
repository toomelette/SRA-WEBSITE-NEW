...
@section('content')
    ...
    <section class="content-header">
        <h1>Weekly Comparative Production</h1>
    </section>
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="weeklyComparativeProduction_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="weeklyComparativeProduction_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            weekly_comparative_production_tbl = $("#weeklyComparativeProduction_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#weeklyComparativeProduction_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#weeklyComparativeProduction_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#weeklyComparativeProduction_table");

            //Need to press enter to search
            $('#weeklyComparativeProduction_filter input').unbind();
            $('#weeklyComparativeProduction_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    weekly_comparative_production_tbl.search(this.value).draw();
                }
            });
        });
