...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="VacantPosition_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="VacantPosition_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            vacant_position_tbl = $("#VacantPosition_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.vacantPosition.index") }}',
                "columns": [
                    { "data": "year" },
                    { "data": "date"},
                    { "data": "file_title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#VacantPosition_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#sVacantPosition_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#VacantPosition_table");

            //Need to press enter to search
            $('#VacantPosition_table_filter input').unbind();
            $('#VacantPosition_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    vacant_position_tbl.search(this.value).draw();
                }
            });
        });
