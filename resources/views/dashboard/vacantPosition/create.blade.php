...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            @csrf
            <form id="VacantPositionForm" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="box-footer">
                    <button id="btnVacantPositionSubmit" type="submit" class="btn btn-default">Save</button>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#VacantPositionForm").submit(function (e) {
            e.preventDefault();
            let form = $(this);
            let formData = new FormData(this);
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.vacantPosition.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    $('form').trigger("reset");
                    $('#btnVacantPositionSubmit').removeAttr("disabled");
                    Swal.fire({
                        title: 'Success!',
                        text: 'New Vacant Position successfully added!',
                        icon: 'success',
