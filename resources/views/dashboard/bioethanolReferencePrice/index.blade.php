...
@section('content')
    ...
    <section class="content-header">
        <h1>Bioethanol Reference Price</h1>
    </section>
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="bioethanolRP_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="bioethanolRP_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            bioethanol_reference_price_tbl = $("#bioethanolRP_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.bioethanolReferencePrice.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "file_title" },
                    { "data": "title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#bioethanolRP_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#bioethanolRP_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#bioethanolRPs_table");

            //Need to press enter to search
            $('#bioethanolRP_table_filter input').unbind();
            $('#bioethanolRP_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    bioethanol_reference_price_tbl.search(this.value).draw();
                }
            });
        });
