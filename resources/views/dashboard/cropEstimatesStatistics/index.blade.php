...
@section('content')
    ...
    <section class="content-header">
        <h1>Crop Estimates & Statistics</h1>
    </section>
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="crop_ES_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="crop_ES_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            crop_ES_tbl = $("#crop_ES_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.cropEstimatesStatistics.index") }}',
                "columns": [
                    { "data": "crop_year" },
                    { "data": "file_title" },
                    { "data": "title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#crop_ES_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#crop_ES_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#crop_ES_table");

            //Need to press enter to search
            $('#crop_ES_table_container input').unbind();
            $('#crop_ES_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    crop_ES_tbl.search(this.value).draw();
                }
            });
        });
