...
@section('content')
    ...
    <section class="content-header">
        <h1>Add Established Block Farm</h1>
    </section>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#blockfarmForm").submit(function (e) {
            ...
            loading_btn(form);
            $.ajax({
                url: "{{route('dashboard.blockFarmEstablishedLozMin.store')}}",
                type: 'POST',
                ...
                success: function (res) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'New Established Block Farm (Lozun and Mindanao) successfully added!',
                        icon: 'success',
