...
@section('content')
    ...
    <section class="content-header">
        <h1>Socialized Credit Program</h1>
    </section>
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                <div id="SocializedCreditProg_table_container" style="">
                    <table class="table table-bordered table-striped table-hover" id="SocializedCreditProg_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            sida_socialized_credit_prog_tbl = $("#SocializedCreditProg_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
                "ajax" : '{{ route("dashboard.socializedCreditProg.index") }}',
                "columns": [
                    { "data": "year" },
                    { "data": "date" },
                    { "data": "file_title" },
                ...
                "initComplete": function( settings, json ) {
                    $('#tbl_loader').fadeOut(function(){
                        $("#SocializedCreditProg_table_container").fadeIn();
                    });
                },
                "language":
                    {
                ...
                "drawCallback": function(settings){
                    ...
                    if(active != ''){
                        $("#SocializedCreditProg_table #"+active).addClass('success');
                    }
                }
            })

            style_datatable("#SocializedCreditProg_table");

            //Need to press enter to search
            $('#SocializedCreditProg_table_filter input').unbind();
            $('#SocializedCreditProg_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    sida_socialized_credit_prog_tbl.search(this.value).draw();
                }
            });
        });
