...
@section('content')
    ...
    <section class="content-header">
        <h1>Manage Power Cogeneration</h1>
    </section>

    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Power Cogeneration</h3>
            ...
            <div class="box-body">
                <div id="power_cogeneration_table_container" style="display: none">
                    <table class="table table-bordered table-striped table-hover" id="power_cogeneration_table" style="width: 100% !important">
                        <thead>
                        <tr class="">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            power_cogeneration_tbl = $("#power_cogeneration_table").DataTable({
              'dom' : 'lBfrtip',
              "processing": true,
              "serverSide": true,
              "ajax" : '{{ route("dashboard.powerCogeneration.index") }}',
              "columns": [
                { "data": "business_name" },
              ...
              "initComplete": function( settings, json ) {
                $('#tbl_loader').fadeOut(function(){
                  $("#power_cogeneration_table_container").fadeIn();
                });
              },
              "language":
                      {
              ...
              "drawCallback": function(settings){
                ...
                if(active != ''){
                  $("#power_cogeneration_table #"+active).addClass('success');
                }
              }
            })
            
            style_datatable("#power_cogeneration_table");
            
            //Need to press enter to search
            $('#power_cogeneration_table_filter input').unbind();
            $('#power_cogeneration_table_filter input').bind('keyup', function (e) {
              if (e.keyCode == 13) {
                  power_cogeneration_tbl.search(this.value).draw();
              }
            });
        });
