...
@section('content')
    ...
    <section class="content-header">
        <h1>Manage Directory of Mills Association/Planters Federation</h1>
    </section>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add Directory of Mills Association/Planters Federation</h4>
                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            active = '';
            stk_directory_mills_assciation_planter_fed_tbl = $("#block_farm_table").DataTable({
                'dom' : 'lBfrtip',
                "processing": true,
                "serverSide": true,
            ...
            $('#block_farm_table_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    stk_directory_mills_assciation_planter_fed_tbl.search(this.value).draw();
                }
            });
        });
        ...
        $("#roadMapForm").submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'Your New Directory successfully added to Directory of Mills Association/Planters Federation!',
                        icon: 'success',
