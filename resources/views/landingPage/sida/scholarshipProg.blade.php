                                                ...
                                                <ul>
                                                    @foreach ($scholarship as $Scholarship)
                                                        @if($year->name == $Scholarship->year)
                                                            <li class="text-justify"><a class="btn" style="color: #ffb600" target="_blank" href="/home/sra_website/{!!$Scholarship->path!!}" >{!!$Scholarship->file_title!!},</a>{!!$Scholarship->title!!}</a></li>
                                                        @endif
                                                    @endforeach
