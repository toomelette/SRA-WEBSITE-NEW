                                                ...
                                                <ul>
                                                    @foreach ($fund_utilization as $fundUtilization)
                                                        @if($cropYear->slug == $fundUtilization->crop_year_slug)
                                                            <li class="text-justify"><a class="btn" style="color: #ffb600" target="_blank" href="/home/sra_website/{!!$fundUtilization->path!!}" >{!!$fundUtilization->file_title!!},</a>{!!$fundUtilization->title!!}</a></li>
                                                        @endif
                                                    @endforeach
