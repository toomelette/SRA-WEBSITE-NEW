                        ...
                        @foreach($crop_year as $cropYear)
                            ...
                            @foreach ($guide_lines as $guideLines)
                                @if($cropYear->slug == $guideLines->crop_year_slug)
                                    <ul>
                                        <li><a style="color: #ffb600" href="/view_file/sida_guide_lines/{!!$guideLines->slug!!}" target="_blank">{!!$guideLines->title!!}, </a>{!!$guideLines->description!!}</li>
                                    </ul>
                                    @endif
                                    @endforeach
                                    @endforeach
