...
{{--                                                            <li class="text-justify"><a class="btn" style="color: #ffb600" target="_blank" href="/home/sra_website/{!!$template->path!!}"><span class="fa fa-play-circle fa-2x"></span>&nbsp;</a>{!!$template->title!!}</li>--}}
