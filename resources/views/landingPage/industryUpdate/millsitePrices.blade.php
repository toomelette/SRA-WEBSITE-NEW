...
<head>
  ...
  ================================================== -->
    <meta charset="utf-8">
    <title>Millsite Prices | SRA</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-heading">
                            <h1 class="banner-title">Millsite Prices</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item active" aria-current="page">Industry Update</li>
                                    <li class="breadcrumb-item active" aria-current="page">Millsite Prices</li>
                                </ol>
                            </nav>
                        </div>
                    </div><!-- Col end -->
                                                ...
                                                <ul>
                                                    @foreach ($millsite_prices as $milesitePrices)
                                                        @if($cropYear->slug == $milesitePrices->crop_year_slug)
                                                            <li class="text-justify"><a class="btn" style="color: #ffb600" target="_blank" href="/view_file/millsite_prices/{!!$milesitePrices->slug!!}" >{!!$milesitePrices->title!!}</a></li>
                                                        @endif
                                                    @endforeach
