...
<div class="body-inner">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-heading">
                            <h1 class="banner-title">Sugar Traders International for Fructose</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item active" aria-current="page">Stakeholders</li>
                                    <li class="breadcrumb-item active" aria-current="page">Sugar Traders International for Fructose</li>
                                </ol>
                            </nav>
                        </div>
                    </div><!-- Col end -->
    ...
    <section id="main-container" class="main-container">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>SUGAR TRADERS INTERNATIONAL FOR FRUCTOSE</h2><br><br>
                    <p>
                    @php
                        $application_form = \App\Models\StkSugarTradersInterFructose::query()->get()->sortBy('id');
                    @endphp
                            ...
                            <div class="row">
                                @foreach ($application_form as $applicationForm)
                                    <div class="col-4">
                                        ...
                                        <li><a style="color: #ffb600" href="/view_file/stk_sugar_traders_inter_fructose/{!!$applicationForm->slug!!}" target="_blank"> {!!$applicationForm->year!!}</a><br>{!!$applicationForm->title!!}</li><br><br>
                                    </div>
                                @endforeach
                            </div>
                        </ul>
