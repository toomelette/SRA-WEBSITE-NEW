                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-heading">
                            <h1 class="banner-title">Sugar Traders International</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item active" aria-current="page">Stakeholders</li>
                                    <li class="breadcrumb-item active" aria-current="page">Sugar Traders International</li>
                                </ol>
                            </nav>
                        </div>
                    </div><!-- Col end -->
                            ...
                            <div class="row">
                                @foreach ($application_form as $applicationForm)
                                    <div class="col-4">
                                        ...
                                        <li><a style="color: #ffb600" href="/view_file/stk_sugar_traders_inter/{!!$applicationForm->slug!!}" target="_blank"> {!!$applicationForm->year!!}</a><br>{!!$applicationForm->title!!}</li><br><br>
                                    </div>
                                @endforeach
                            </div>
                        </ul>
