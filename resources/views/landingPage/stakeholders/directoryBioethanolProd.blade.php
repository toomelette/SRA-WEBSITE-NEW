...
<div class="body-inner">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-heading">
                            <h1 class="banner-title">Directory of Bioethanol Producers</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item active" aria-current="page">Stakeholders</li>
                                    <li class="breadcrumb-item active" aria-current="page">Directory of Bioethanol Producers</li>
                                </ol>
                            </nav>
                        </div>
                    </div><!-- Col end -->
    ...
    <section id="main-container" class="main-container">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>DIRECTORY OF BIOETHANOL PRODUCERS</h2><br><br>
                    <p>
                    @php
                        $application_form = \App\Models\StkDirectoryBioethanolProducers::query()->get()->sortBy('id');
                    @endphp
                            ...
                            <div class="row">
                                @foreach ($application_form as $applicationForm)
                                    <div class="col-4">
                                        ...
                                        <li><a style="color: #ffb600" href="/view_file/stk_directory_bioethanol_producers/{!!$applicationForm->slug!!}" target="_blank"> {!!$applicationForm->year!!}</a><br>{!!$applicationForm->title!!}</li><br><br>
                                    </div>
                                @endforeach
                            </div>
                        </ul>
