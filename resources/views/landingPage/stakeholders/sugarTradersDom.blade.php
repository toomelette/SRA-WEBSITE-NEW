                            ...
                            <div class="row">
                                @foreach ($application_form as $applicationForm)
                                    <div class="col-4">
                                        ...
                                        <li><a style="color: #ffb600" href="/view_file/stk_sugar_traders_dom/{!!$applicationForm->slug!!}" target="_blank"> {!!$applicationForm->year!!}</a><br>{!!$applicationForm->title!!}</li><br><br>
                                    </div>
                                @endforeach
                            </div>
                        </ul>
