                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-heading">
                            <h1 class="banner-title">Directory of Sugar Mills</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item active" aria-current="page">Stakeholders</li>
                                    <li class="breadcrumb-item active" aria-current="page">Directory of Sugar Mills</li>
                                </ol>
                            </nav>
                        </div>
                    </div><!-- Col end -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>DIRECTORY OF SUGAR MILLS</h2><br><br>
                    <p>
                    @php
                        $application_form = \App\Models\StkDirectorySugarMills::query()->get()->sortBy('id');
                    @endphp
                            ...
                            <div class="row">
                                @foreach ($application_form as $applicationForm)
                                    <div class="col-4">
                                        ...
                                        <li><a style="color: #ffb600" href="/view_file/stk_directory_sugar_mills/{!!$applicationForm->slug!!}" target="_blank"> {!!$applicationForm->year!!}</a><br>{!!$applicationForm->title!!}</li><br><br>
                                    </div>
                                @endforeach
                            </div>
                        </ul>
