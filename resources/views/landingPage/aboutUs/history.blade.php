...
<div class="body-inner">
  ...
  <section id="main-container" class="main-container">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 history-container">
          <p>
          ...
          <p>
            The first members of the Board of the Sugar Regulatory Administration for the term 1986 to 1989 were:
            <br><br><i>Atty. Arsenio B. Yulo, Jr.  –   Chairman</i>
            <br><i>Mr. Carlos Ledesma        –   Member</i>
            <br><i>Mr. Bibiano Sabino          –   Member</i>
          </p>
          <p>
            Immediately after assumption to office, these officials promulgated the following policy guidelines:
          ...
          <p>
            In June 1989, the terms of the two board member expired. They were replaced accordingly.
          </p>
          <p>
            For the term 1989 to 1992, the Board members were:
            <br><br><i>Atty. Arsenio B. Yulo, Jr.  –   Chairman</i>
            <br><i>Mr. Carlos Ledesma        –   Member</i>
            <br><i>Mr. Bibiano Sabino          –   Member</i>
          </p>
          <p>
            Executive Order No. 631 dated July 9, 2007 declared SRA as a Government Owned and Controlled Corporation (GOCC).  The Administrative Code of 1987 provides that SRA is an attached unit of the Department of Agriculture but shall continue to operate and function in accordance with its charter.  Furthermore, it provides that the Secretary of the Department of Agriculture shall serve as Chairman of the governing board of SRA.  Upon the promulgation of the Administrative Code of 1987, Atty. Arsenio B. Yulo, Jr. who was discharging the duties as Chairman of the Sugar Board and SRA Administrator then served as the Administrator of SRA under the Chairmanship of Secretary Senen C. Bacani. On February 8, 1992, Administrator Yulo resigned and he was replaced by Atty. Rodolfo A. Gamboa. The position of Board member representing the planters was given to Atty. Vicente Oliva, who served the unexpired term of Atty. Gamboa.
          </p>
          <p>
            <table style="width: 60%;" cellspacing="0" cellpadding="0" border="1">
              <tbody>
          ...
          <p>
            The current  Acting Administrator of SRA is David John Thaddeus P. Alba concurrently sits in the Sugar Board with board members , Pablo Luis S. Azcona representing the planters’ sector and Ma. Mitzi V. Mangwag, representing the millers’ sector, under the chairmanship of the Department of Agriculture Secretary, President FERDINAND “Bongbong” R. MARCOS, Jr.
          </p>
          <p>
            A chronology of laws and statutes which charted the significant events of the sugar industry is presented here under.
          </p>
          <p>
            The Philippine sugar industry has sailed through rough and better times. During adverse circumstances, the industry has always been victorious. In these critical times, one note of optimism pervading the industry is that "when one reaches the bottom, there is no other way but up".
          </p>
        </div><!-- Col end -->
      </div><!-- Content row end -->
    </div><!-- Container end -->
...
@yield('scripts')
  ...
  <script type="text/javascript">
    function viewNav(routE){
      window.open("{{route('navRoute')}}".replace('navRoute', routE)).focus();
    }
  </script>
