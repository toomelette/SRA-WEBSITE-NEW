...
================================================== -->
  <meta charset="utf-8">
  <title>Bioethanol Producer | SRA</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="banner-heading">
              <h1 class="banner-title">Bioethanol Producer</h1>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                  <li class="breadcrumb-item active" aria-current="page">Business Opportunities</li>
                  <li class="breadcrumb-item active" aria-current="page">How to be a Bioethanol Producer?</li>
                </ol>
              </nav>
            </div>
          </div><!-- Col end -->
  ...
  <section id="main-container" class="main-container mb-lg-5 mt-lg-5">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          <h4 class="column-title">How to be a Bioethanol Producer?</h4>
          <p><strong>Please completely fill up the form below:</strong></p>
          <form id="bioethanolProducerForm" name="bioethanolProducerForm" method="post" role="form">
            @csrf
...
@yield('scripts')
  <script type="text/javascript">
    $(function () {
      $('form#bioethanolProducerForm').on('submit', function (event) {
        $.ajax({
          type: 'post',
          url: "{{route('bioethanolProducerStore')}}",
          data: $('form').serialize(),
