...
<head>
  ...
  ================================================== -->
    <meta charset="utf-8">
    <title>Notice of Proceed | SRA</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-heading">
                            <h1 class="banner-title">Notice of Proceed</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item active" aria-current="page">Bid Corner</li>
                                    <li class="breadcrumb-item active" aria-current="page">Notice of Proceed</li>
                                </ol>
                            </nav>
                        </div>
                    </div><!-- Col end -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p>
                    @php
                        $Template = \App\Models\NoticeProceed::query()->get()->sortByDesc('id');
                                                ...
                                                <ul>
                                                    @foreach ($Template as $template)
                                                        @if($cropYear->slug == $template->crop_year_slug)
                                                            <li class="text-justify"><a class="btn" style="color: #ffb600" target="_blank" href="/view_file/notice_proceed/{!!$template->slug!!}" >{!!$template->file_title!!},</a>{!!$template->title!!}</a></li>
                                                        @endif
                                                    @endforeach
...
{{--                    <p>--}}
{{--                    @php--}}
{{--                        $noticeProceed = \App\Models\NoticeProceed::query()->get()->sortByDesc('id');--}}
{{--                        $crop_year = \App\Models\CropYear::query()->get()->sortByDesc('id');--}}
{{--                        $clYearList = array();--}}
{{--                        foreach($noticeProceed as $cl){--}}
{{--                          array_push($clYearList, $cl->crop_year);--}}
{{--                          array_push($clYearList, $cl->crop_year);--}}
{{--                        }--}}
{{--                        $clYearList = array_unique($clYearList);--}}
{{--                    @endphp--}}
{{--                    @if(count($noticeProceed) > 0)--}}
{{--                        @foreach($crop_year as $cropYear)--}}
{{--                            @if(in_array($cropYear->name, $clYearList))--}}
{{--                                <h4>Series of {!!$cropYear->name!!}</h4>--}}
{{--                            @endif--}}
{{--                            @foreach ($noticeProceed as $notice_proceed)--}}
{{--                                @if($cropYear->slug == $notice_proceed->crop_year_slug)--}}
{{--                                    <ul>--}}
{{--                                        <li><a style="color: #ffb600" href="/home/sra_website/{!!$notice_proceed->path!!}" target="_blank">{!!$notice_proceed->file_title!!}, </a>{!!$notice_proceed->title!!}</li>--}}
{{--                                    </ul>--}}
{{--                                    @endif--}}
{{--                                    @endforeach--}}
{{--                                    @endforeach--}}
