...
<head>
  ...
  ================================================== -->
    <meta charset="utf-8">
    <title>Supplemental Bid | SRA</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-heading">
                            <h1 class="banner-title">Supplemental Bid</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item active" aria-current="page">Bid Corner</li>
                                    <li class="breadcrumb-item active" aria-current="page">Supplemental Bid</li>
                                </ol>
                            </nav>
                        </div>
                    </div><!-- Col end -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p>
                    @php
                        $Template = \App\Models\SupplementalBid::query()->get()->sortByDesc('id');
...
{{--                    <p>--}}
{{--                    @php--}}
{{--                        $supplementalBid = \App\Models\SupplementalBid::query()->get()->sortByDesc('id');--}}
{{--                        $crop_year = \App\Models\CropYear::query()->get()->sortByDesc('id');--}}
{{--                        $clYearList = array();--}}
{{--                        foreach($supplementalBid as $cl){--}}
{{--                          array_push($clYearList, $cl->crop_year);--}}
{{--                          array_push($clYearList, $cl->crop_year);--}}
{{--                        }--}}
{{--                        $clYearList = array_unique($clYearList);--}}
{{--                    @endphp--}}
{{--                    @if(count($supplementalBid) > 0)--}}
{{--                        @foreach($crop_year as $cropYear)--}}
{{--                            @if(in_array($cropYear->name, $clYearList))--}}
{{--                                <h4>Series of {!!$cropYear->name!!}</h4>--}}
{{--                            @endif--}}
{{--                            @foreach ($supplementalBid as $supplemental_bid)--}}
{{--                                @if($cropYear->slug == $supplemental_bid->crop_year_slug)--}}
{{--                                    <ul>--}}
{{--                                        <li><a style="color: #ffb600" href="/home/sra_website/{!!$supplemental_bid->path!!}" target="_blank">{!!$supplemental_bid->file_title!!}, </a>{!!$supplemental_bid->title!!}</li>--}}
{{--                                    </ul>--}}
{{--                                    @endif--}}
{{--                                    @endforeach--}}
{{--                                    @endforeach--}}
