                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-heading">
                            <h1 class="banner-title">Sugar Law</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item active" aria-current="page">Policy</li>
                                    <li class="breadcrumb-item active" aria-current="page">Sugar Law</li>
                                </ol>
                            </nav>
                        </div>
                    </div><!-- Col end -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>
                    @php
                        $sugar_law= \App\Models\SugarLaw::query()->get()->sortByDesc('id');
