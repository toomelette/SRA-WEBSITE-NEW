                        ...
                        <ul>
                          @foreach ($circular_letter as $circularLetter)
                            @if($cropYear->slug == $circularLetter->crop_year_slug)
                              <li class="text-justify"><a class="btn" style="color: #ffb600" target="_blank" href="/view_file/circular_letter/{!!$circularLetter->slug!!}" >{!!$circularLetter->title!!},</a>{!!$circularLetter->description!!}</a></li>
                            @endif
                          @endforeach
