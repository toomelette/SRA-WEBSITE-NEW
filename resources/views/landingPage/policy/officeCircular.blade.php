                        ...
                        <ul>
                          @foreach ($office_circular as $officeCircular)
                            @if($year->name == $officeCircular->year)
                              <li class="text-justify"><a class="btn" style="color: #ffb600" target="_blank" href="/home/sra_website/{!!$officeCircular->path!!}" >{!!$officeCircular->file_title!!},</a>{!!$officeCircular->title!!}</a></li>
                            @endif
                          @endforeach
