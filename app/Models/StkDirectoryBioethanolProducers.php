...
class StkDirectoryBioethanolProducers extends Model{
    ...
    protected $table = 'stk_directory_bioethanol_producers';

    protected $dates = ['created_at', 'updated_at'];

    public $timestamps = true;

    protected static $logName = 'stk_directory_bioethanol_producers';
