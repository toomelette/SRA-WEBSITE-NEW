...
class StkDirectoryMillsAssociationPlantersFed extends Model{
    ...
    protected $table = 'stk_directory_mills_assciation_planter_fed';

    protected $dates = ['created_at', 'updated_at'];

    public $timestamps = true;

    protected static $logName = 'stk_directory_mills_assciation_planter_fed';
